...
| Built the Rolex classification model, recognition pipeline, backend API, model integration, and Modal deployment setup. | Brought the project design to life by implementing the frontend, UI layout, interactions, styling, visual effects, and Vercel deployment. |
